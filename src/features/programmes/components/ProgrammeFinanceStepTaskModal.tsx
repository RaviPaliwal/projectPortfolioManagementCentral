...
import { ProgrammeFinanceTaskModal } from './ProgrammeFinanceTaskModal'
...
export interface ProgrammeFinanceTaskModalWrapperProps {
  approvalStepId: string
  onClose: () => void
  onSuccess?: (msg: string) => void
  onError?: (msg: string) => void
...
export const ProgrammeFinanceTaskModalWrapper: React.FC<ProgrammeFinanceTaskModalWrapperProps> = ({
