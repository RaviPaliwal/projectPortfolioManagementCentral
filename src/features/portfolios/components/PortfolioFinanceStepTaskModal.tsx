...
import { PortfolioFinanceTaskModal } from './PortfolioFinanceTaskModal'
...
export interface PortfolioFinanceTaskModalWrapperProps {
  approvalStepId: string
  onClose: () => void
  onSuccess?: (msg: string) => void
  onError?: (msg: string) => void
...
export const PortfolioFinanceTaskModalWrapper: React.FC<PortfolioFinanceTaskModalWrapperProps> = ({
