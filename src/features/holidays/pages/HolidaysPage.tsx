    ...
    <Box>
      ...
      <Box sx={{ display: 'flex', gap: 1, mb: 2, flexWrap: 'wrap' }}>
        <ExportButton
          ...
          columns={holidayExportColumns}
          filename={'HolidayCalendar_' + calendarYear}
        />
        <Button
          variant="outlined"
          startIcon={<FlagIcon />}
                  ...
                  <CardContent sx={{ p: 2.5, '&:last-child': { pb: 2.5 } }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1.5 }}>
                      ...
                      <Chip
                        ...
                        sx={{ fontWeight: 700, minWidth: 28, borderRadius: 8 }}
                      />
                    </Box>
                  ...
                  >
                    ...
                    <TableCell align="center">
                      <Chip
                        ...
                        size="small"
                        sx={{ fontWeight: 600, borderRadius: 8, minWidth: 70 }}
                      />
                    </TableCell>
      ...
      <DetailDrawer
        ...
        subtitle={selectedHoliday && (
          <Chip icon={<PublicIcon sx={{ fontSize: 14 }} />} label={selectedHoliday.pm_country || '\u2014'} size="small" variant="outlined" sx={{ fontWeight: 600, borderRadius: 8 }} />
        )}
        headerActions={
            ...
            <Paper variant="outlined" sx={{ p: 2.5, borderRadius: 2 }}>
              ...
              <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
                ...
                <Box>
                  ...
                  <Chip label={selectedHoliday.pm_isfixeddate ? 'Fixed Date' : 'Variable Date'} color={selectedHoliday.pm_isfixeddate ? 'primary' : 'warning'} size="small" sx={{ fontWeight: 600, borderRadius: 8 }} />
                </Box>
                <Box>
