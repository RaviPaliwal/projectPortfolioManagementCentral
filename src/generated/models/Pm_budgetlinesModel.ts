 ...
 */
export const Pm_budgetlinespm_budgetlinestatus = {
  1: 'UnderApproval',
  2: 'Approved',
  3: 'Rejected'
} as const;
export type Pm_budgetlinespm_budgetlinestatus = keyof typeof Pm_budgetlinespm_budgetlinestatus;
...
export interface Pm_budgetlinesBase {
  ...
  pm_budgetlinestatus?: Pm_budgetlinespm_budgetlinestatus;
